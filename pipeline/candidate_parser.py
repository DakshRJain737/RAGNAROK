...
# candidates = candidate_parser.build_candidate_list(Path("sample_candidates.json"))
...
# print(count) # count = 24 out of 50 i.e 24 honeypot candidates detected

# for c in candidates:
#     trajectory_analyser = TrajectoryAnalyzer()
#     traj = trajectory_analyser.build_feature_vector(c)
...
# results = bm25.search("Senior AI Engineer embedding retrieval ranking", top_k=25)
...
# # ── Sanity checks ──────────────────────────────
# print("Shape      :", matrix.shape)               # should be (50, 30)
# print("Min value  :", matrix.min())               # should be >= 0.0
# print("Max value  :", matrix.max())               # should be <= 1.0
# print("Any NaN?   :", np.isnan(matrix).any())     # should be False
# print("Any Inf?   :", np.isinf(matrix).any())     # should be False

# # ── Per-feature column means (are signals alive?) ──
# FEATURE_NAMES = [
#     "recency", "response_rate", "open_to_work", "notice_score",
#     "github", "completeness", "interview", "offer",
#     "views_30d", "apps_30d", "search_30d", "saved_30d",
#     "connections", "endorsements", "verified_email", "verified_phone",
#     "linkedin", "relocate", "notice_raw", "work_mode",
#     "salary_min", "salary_max", "response_time",
#     "yoe_score", "product_exp", "stability", "job_hopper_stable",
#     "skill_assessment", "is_honeypot", "is_consulting"
# ]

# print("\nColumn means:")
# for name, mean in zip(FEATURE_NAMES, matrix.mean(axis=0)):
#     print(f"  {name:<20} {mean:.3f}")
